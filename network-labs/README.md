...
| `lab-04.html` | `RGSV_Network_Lab_04_v4.html` | Type a URL and press Go to run the full DNS and HTTP journey; Next step remains available for teaching. |
...
Lab 04 shows one DNS server (192.168.1.53) and three separate web servers: School (203.0.113.20), Library (203.0.113.30) and Sport (203.0.113.40). DNS returns the matching IP; only that server receives the HTTP request and returns the HTML. Go or Enter runs all six steps automatically; Go is always active and restarts even during a running or paused step. The other playback control only pauses or continues; no second Play click is needed. DNS hierarchy, caching, TCP and TLS are outside this simplified model. All websites are virtual.
...
```
12f64e88ac35fbaec43816647b61ebd297e284f789977f043c58245137528aa0  index.html
...
6116038b92db1d614aa5c0f9358e7130881b1f62ca5c6fa9782244a868231eee  lab-04.html
```
