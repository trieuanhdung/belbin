...
| `lab-04.html` | `RGSV_Network_Lab_04_v5.html` | Type a URL and press Go to run the full DNS and HTTP journey; Next step remains available for teaching. |
...
Lab 04 shows one DNS server (10.0.0.1) and three separate web servers: School (10.0.0.2), Library (10.0.0.3) and Sport (10.0.0.4). DNS returns the matching IP; only that server receives the HTTP request and returns the HTML. Go or Enter runs all six steps automatically; Go is always active and restarts even during a running or paused step. The other playback control only pauses or continues; no second Play click is needed. DNS hierarchy, caching, TCP and TLS are outside this simplified model. All websites are virtual.
...
```
b8c4a6a51bf1113092c3e9646bdb1ae7c494ad1a36940b8f16cb796b713de21d  index.html
...
5ba25c61ad6f9061be4709c58d2575b596769ed2c6203b4be30e0e40a4c2acb0  lab-04.html
```
